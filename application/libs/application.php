...
class Application
{
    ...
    public function __construct()
    {
        ...
        if (file_exists('./application/controller/' . $this->url_controller . '.php')) {
            ...
            // invalid URL, so simply show visor/index
            require './application/controller/visor.php';
            $visor = new Visor();
            $visor->index();
        }
    }
    ...
    private function splitUrl()
    {
        if (isset($_GET['url'])) {
            ...
            $this->url_controller = (isset($url[0]) ? $url[0] : null); //"(condition) ? (true return value) : (false return value)"
